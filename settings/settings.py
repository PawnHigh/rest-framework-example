...
RENDER_EXTERNAL_HOSTNAME = os.environ.get('RENDER_EXTERNAL_HOSTNAME') # Production
if RENDER_EXTERNAL_HOSTNAME: # Production
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME) # Production
